...
searchInput.innerHTML = '<label>Search:<input type="search" id="searchInput" onkeyup="search()"></label>';
searchInput.setAttribute("id", "myTable_filter");
searchInput.setAttribute("class", "dataTables_filter");
...
for (var i = 0; i < headers.length; i++) {
    ...
    headers[i].setAttribute('index', i);
}
